...
+
** 透過連接埠 443 連接到 Cloud Tiering 服務和 Azure Blob 物件儲存設備的 HTTPS 連線 (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["請參閱端點清單"^]）
